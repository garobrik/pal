...
Widget _dropdownMenu<T>(
  ...
  AlignmentGeometry childAnchor = AlignmentDirectional.bottomStart,
  AlignmentGeometry dropdownAnchor = AlignmentDirectional.topStart,
}) {
...
Widget _followingDeferredPainter(
  ...
  Offset offset = Offset.zero,
  AlignmentGeometry childAnchor = AlignmentDirectional.topStart,
  AlignmentGeometry overlayAnchor = AlignmentDirectional.topStart,
  bool constrainHeight = false,
  bool constrainWidth = false,
  BoxConstraints Function(BoxConstraints)? modifyConstraints,
}) {
          ...
          child: overflowPart(
            child: DeferredPainter(
              child: CompositedTransformFollower(
                link: link,
                offset: offset,
                targetAnchor: childAnchor.resolve(Directionality.of(context)),
                followerAnchor: overlayAnchor.resolve(Directionality.of(context)),
                child: deferee,
              ),
            ),
          ),
