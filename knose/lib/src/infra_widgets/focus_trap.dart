...
///
/// Copied from GitHub user venkatd here: https://github.com/flutter/flutter/issues/86972#issuecomment-917251298
class DisableBuiltinFocusTrap extends StatefulWidget {
  const DisableBuiltinFocusTrap({required this.child, Key? key}) : super(key: key);

  final Widget child;

  @override
  State<StatefulWidget> createState() => _DisableBuiltinFocusTrapState();
}

class _DisableBuiltinFocusTrapState extends State<DisableBuiltinFocusTrap> {
  late FocusNode focusNode;

  @override
  void initState() {
    super.initState();
    focusNode = FocusManager.instance.primaryFocus ?? FocusManager.instance.rootScope;
  ...
  void _onFocusNodeChanged() {
    final newFocusNode = FocusManager.instance.primaryFocus ?? FocusManager.instance.rootScope;
